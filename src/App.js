...
function App() {
  ...
  // const [useuppy,setUseuppy] = useState(null)
  ...
  //     if (authuser) {
  //       setUseuppy(authuser);
  //       console.log("CHECCCCCC------>",authuser)
  //     } else {
  //       setUseuppy(null);
  //     }
  //   });
    ...
    <div className="App">
      <Modal open={open} onClose={() => setOpen(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            ...
            />
            {/* <Button type="submit" onClick={signuppy}>
              Sign Uppy
            </Button> */}
      ...
      <div className="app__header">
        ...
        {user?.displayName ? (
          ...
          <div className="app__loginContainer">
            ...
            {/* <Button onClick={() => setOpen(true)}>Sign Uppy</Button> */}
          </div>
        )}
      </div>
      ...
      <div className="app__posts">
        ...
        <div className="app__postsright">
          <InstagramEmbed
            url="https://www.instagram.com/p/CAkBmQKANZc/?"
            maxWidth={300}
            hideCaption={false}
